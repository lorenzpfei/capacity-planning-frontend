...
import {
    ...
    Divider,
    Checkbox,
    Stack, Switch, useMantineTheme, useMantineColorScheme,
} from '@mantine/core';
            ...
            <div style={{
                ...
                <Paper radius="md" p="xl" withBorder style={{width: 400, maxWidth: '100%'}}>
                    ...
                    <Group grow mb="md" mt="md">
                        <Link to={`${process.env.REACT_APP_PUBLIC_API_URL}/oauth/azure/`} style={{display: "block"}}>
                            <MicrosoftButton radius="xl" style={{width: '100%'}}>Microsoft</MicrosoftButton>
                        </Link>
                    </Group>
